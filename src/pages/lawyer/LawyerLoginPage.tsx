...
import { Eye, EyeOff, Scale, ShieldCheck, LockKeyhole, User, FileText, BriefcaseBusiness } from 'lucide-react';
      ...
      <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 bg-gray-50">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-legal-primary">Justice Scribe Online</h1>
            <p className="mt-2 text-gray-600">변호사 플랫폼 로그인</p>
          </div>
          
          <Card className="shadow-elegant">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl text-center text-navy-700">변호사 포털 접속</CardTitle>
              <CardDescription className="text-center">
                계정으로 로그인하여 사건 및 문서를 관리하세요
              </CardDescription>
            </CardHeader>
              ...
              <div className="pt-2 border-t border-gray-200 w-full">
                <div className="text-center text-sm text-gray-600">
                  <div className="flex items-center justify-center space-x-2 mb-2">
                    <BriefcaseBusiness className="h-4 w-4 text-legal-accent" />
                    <span>데모 계정: lawyer@example.com / password123</span>
                  </div>
